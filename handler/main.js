...
Object.db.exec("CREATE TABLE IF NOT EXISTS `keyban` (`user` varchar(255) NOT NULL)")


Object.config = require('./config.json')

const bot = new BotManager({partials: ['MESSAGE', 'CHANNEL', 'REACTION'], intents: 32767, disableMentions: 'everyone'},Object); bot.run()
const cbot = bot.get()
Object.bot = cbot;
