...
Object.db.exec("CREATE TABLE IF NOT EXISTS `bans` (`uuid` varchar(255) NOT NULL, `reason` varchar(255) NOT NULL, `proof` varchar(255) NOT NULL, `date` varchar(255) NOT NULL)")
